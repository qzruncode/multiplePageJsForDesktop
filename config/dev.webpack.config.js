...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ template: "./public/index.html", filename: "index.html", chunks: ['index', 'vendor'] }),
        new HtmlWebpackPlugin({ template: "./public/another.html", filename: "another.html", chunks: ['another', 'vendor'] }),
